    ...
    sections: [
      ...
      { id: 'setbacks', title: 'Setbacks',
        ...
        list: [
          ...
          { label: 'Usability testing flagged adoption risk.', text: 'The changes were too far removed from the current product. Existing users — who had built workflows around the old patterns over years — pushed back. The data suggested low adoption if we shipped it as-is.' },
      ...
      { id: 'facelift-sidebar', title: 'Right Sidebar & AI Assistant',
        ...
        media: [
          { src: 'redesign/40.png', caption: 'Right sidebar — contextual panels', kind: 'wide' },
          { src: 'redesign/new-design-sidebar.mov', caption: 'Sidebar prototype', kind: 'wide' },
        ],
      },
      { id: 'scrapped', title: 'The Scrapped Design',
        ...
        media: [
          { src: 'redesign/47.png', caption: 'Scrapped editor concept', kind: 'sq' },
          { src: 'redesign/50.png', caption: 'Scrapped editor concept', kind: 'sq' },
          { src: 'redesign/52.png', caption: 'Scrapped editor concept', kind: 'sq' },
        ],
      },
